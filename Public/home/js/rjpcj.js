...
jQuery.fn.keyboard = function(options){
	...
	var make = function(){
		...
		<div class="keyboard_norm keyboard_type ru">\
			...
			<table class="keyboard_row">\
				<tr>\
					<td><span class="keyboard_key capslock"><span class="keyboard_key-m"><img src=""+Public+"/home/img/capslock.png" alt="capslock"/></span></span></td>\
					...
					<td><span class="keyboard_key"><span class="keyboard_key-m">!</span></span></td>\
					<td><span class="keyboard_key enter"><span class="keyboard_key-m"><img src=""+Public+"/home/img/enter.png" alt="enter"/></span></span></td>\
				</tr>\
			</table>\
			<table class="keyboard_row">\
				<tr>\
					<td><span class="keyboard_key lshift"><span class="keyboard_key-m"><img src=""+Public+"/home/img/shift.png" alt="shift"/></span></span></td>\
					...
					<td><span class="keyboard_key"><span class="keyboard_key-m">,</span></span></td>\
					<td><span class="keyboard_key"><span class="keyboard_key-m">.</span></span></td>\
					<td><span class="keyboard_key rshift"><span class="keyboard_key-m"><img src=""+Public+"/home/img/shift.png" alt="shift"/></span></span></td>\
				</tr>\
			</table>\
		</div>\
		...
		*/
		$('body').click(function(){
			$keyboard.find('.keyboard_lang-selector').fadeOut(1);
			return true;
		});
		
		$ico.click(function(){
			$keyboard.css({left:'', right:''});
			$keyboard.css({}).fadeToggle(0);
